"""Where k141 overlap edges agree with the simulated genus on low75_enriched.

Kraken genus labels come from ``work/reprofile/contigs.kraken``. Truth is the
best minimap2 alignment of each contig to the simulated genomes. An edge with
one labelled end is a rescue: it counts as a match when the labelled genus
equals the unlabelled contig's true genus.
"""
...
EXAMPLE = ROOT / "examples" / "low75_enriched"
WORK = EXAMPLE / "work"
