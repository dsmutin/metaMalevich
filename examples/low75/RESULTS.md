...
Coverage ratio has the same median, 1, on true and false neighbour pairs. Kraken k-mer support medians are 0.226 and 0.154. Eight rounds of propagation along edges with 4-mer cosine at least 0.5 relabel 3179 nodes. Kaiju genus L1 becomes 0.96658 and Kraken2 1.4595. Correct bases rise only to 0.185. See `ds/propagate_k21.tsv`.
