...
`examples/heldout_genera/` is a from-scratch community: twenty simulated assemblies and twenty held-out assemblies used as the Kraken2 and Kaiju databases. Genomes, reads, and indexes are not committed. See that directory's README.
